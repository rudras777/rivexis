...
- Latest fully certified application head before this documentation-only state sync: `3fc8764237dd09ede77c80d64e645a33574da40b`.
- CI #401 (`36166264178`) passed API ruff/pytest/pip-audit, frontend type/build/vinext/npm-audit/Playwright E2E, invariants/secret/migration checks, and PostgreSQL migration/runtime-control certification on that head.
- GitHub Pages deployment #72 (`36166263499`) also passed on that head.
