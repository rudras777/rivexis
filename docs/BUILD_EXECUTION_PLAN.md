...
- Latest fully certified application head before this documentation-only state sync: `c84fb4643b288785e48354e9b429cd27125135ff`.
- CI #399 (`36161569915`) passed API ruff/pytest/pip-audit, frontend type/build/vinext/npm-audit/Playwright E2E, invariants/secret/migration checks, and PostgreSQL migration/runtime-control certification on that head.
- GitHub Pages deployment #70 (`36161569163`) also passed on that head.
