...
- Latest certified application head: `17410346212ed871fc2d6cff7ac6000c3104b78b` (`Harden F4 yield evidence integrity`).
- CI #405 (`36169771582`) passed the complete matrix on that exact head: API ruff/pytest/pip-audit; web edge/web typechecks, Next build, vinext build, npm audit and Playwright; invariants/secret/migration checks; PostgreSQL migration/runtime-control/migrated-schema verification. Pages #76 (`36169770434`) also passed on the exact head.
