...
**B4.** Direct-chain and external-provider evidence stay distinct. Native-balance state is pinned to the captured block. Token identity is contract-based, malformed rows are excluded, and counterparty concentration is descriptive interaction concentration—not ownership, maliciousness or economic exposure.
...
- `bab6bf2b56fbdef7bfc059f9e6e5c169da567838` — B1 verified-ABI dynamic decoder hardening — CI #342 (`35933008604`) PASS; focused regression tests follow at `e285b83af7d3a70f4052d9c8e41d298456869bf6` and are included in the current full-CI-gated state lineage.
